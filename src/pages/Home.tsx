    ...
    <div className=" relative p-5 pt-[4rem]">
      ...
      <div className=" z-40 relative pt-5">
        ...
        <motion.ul
          ...
          initial="hidden"
          animate="visible"
          className="grid gap-5 grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 2xl:grid-cols-6 py-4"
        >
          {albums?.map((item, i) => (
            <motion.li
              variants={itemCard}
            ...
            >
              <Link to={`/artist/${item.artistId}`}>
                <div className="items-center flex flex-col relative">
                  ...
                  />
                  {hoveredIndex === i && (
                    <div className=" p-2 absolute bottom-0 right-0 z-50">
